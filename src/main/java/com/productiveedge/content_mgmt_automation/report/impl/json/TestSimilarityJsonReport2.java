...
public class TestSimilarityJsonReport2 implements Report<Map<String, Set<Page>>> {
    private static final Logger logger = LoggerFactory.getLogger(TestSimilarityJsonReport2.class);
    private final File reportFile;
    private final String reportFilePath;

    public TestSimilarityJsonReport2(String filePath) {
        //need to be checked
