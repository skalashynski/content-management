...
public class TagUtil {
    ...
    public static String generateShortXpath(Element element) {
    ...
    public static String generateFullXpath(Element element) {
        String idAttr = element.id();
        if (idAttr != null) {
            if (!idAttr.isEmpty()) {
                return "//*[@id=\"" + idAttr + "\"]";
    ...
    public static String generateFullXpathBasedOnTags(Element element) {
        String xpath = "";
        String itElementXpath = "";
        Element parent = element.parent();
        while (parent != null) {
